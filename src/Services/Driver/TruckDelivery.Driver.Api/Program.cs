...
using TruckDelivery.Driver.Infrastructure.Extensions;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Driver & Vehicle API", Version = "v1" });
...
builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssembly(
    typeof(RegisterDriverCommandHandler).Assembly));
builder.Services.AddValidatorsFromAssembly(typeof(RegisterDriverCommandHandler).Assembly);
...
builder.Services.AddOpenTelemetry()
    .ConfigureResource(r => r.AddService("driver", "truck-delivery"))
    .WithTracing(t => t

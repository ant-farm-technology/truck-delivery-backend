...
using Serilog;
using System.Text;
using TruckDelivery.Analytics.Api.Middlewares;
using TruckDelivery.Analytics.Application.Behaviors;
using TruckDelivery.Analytics.Application.Commands.RecordBreakdown;
using TruckDelivery.Analytics.Infrastructure.Extensions;
...
{
    cfg.RegisterServicesFromAssembly(typeof(RecordBreakdownCommandHandler).Assembly);
...
builder.Services.AddOpenTelemetry()
    .ConfigureResource(r => r.AddService("analytics", "truck-delivery"))
    .WithTracing(t => t
